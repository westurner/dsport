...
| `test_highlighting.py` | highlighting | P3 | **partial** — native alias selection and normalized token-span parity are covered; dedicated Sphinx lexer-error and diagnostic parity remains (→ **H10**) |
