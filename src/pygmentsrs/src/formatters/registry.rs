...
use crate::formatters::markup::{
    GroffFormatter, LatexFormatter, PangoMarkupFormatter, RtfFormatter,
};
use crate::formatters::svg::SvgFormatter;
use crate::formatters::terminal::{
    BBCodeFormatter, IRCFormatter, Terminal256Formatter, TerminalFormatter,
