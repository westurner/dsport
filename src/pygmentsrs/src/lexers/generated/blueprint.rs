...
fn build_table() -> Table {
    ...
    m.insert(
        ...
        vec![
            ...
            Rule::token_to(
                r"(?im)/\*",
                COMMENT_MULTILINE,
                NewState::Push(vec![r"comment-multiline"]),
            ),
        ],
    );
    m.insert(
    ...
    m.insert(
        ...
        vec![
            ...
            Rule::bygroups(
                r"(?im)(?:([a-z_][a-z0-9_\-]*)(\s*)(\.)(\s*))?([a-z_][a-z0-9_\-]*)",
                vec![
                    Some(NAME_NAMESPACE),
                    Some(WHITESPACE),
                    Some(PUNCTUATION),
    ...
    m.insert(
        ...
        vec![
            ...
            Rule::token_to(
                r"(?im)\{",
                PUNCTUATION,
                NewState::Push(vec![r"#pop", r"brace-block"]),
            ),
        ],
    );
    Table(m)
