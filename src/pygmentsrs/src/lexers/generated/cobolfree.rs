...
//! AUTO-GENERATED from `pygments.pygments.lexers.business:CobolFreeformatLexer`.
//!
//! Do not edit by hand. Regenerate with:
//!   python tools/gen_lexer.py pygments.lexers.business:CobolFreeformatLexer:cobolfree
