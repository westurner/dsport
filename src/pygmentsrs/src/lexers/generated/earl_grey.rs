...
fn build_table() -> Table {
    ...
    m.insert(
        ...
        vec![
            Rule::token(
                ...
                (?!and|as|each\*|each|in|is|mod|of|or|when|where|with)
                (?=(?:[+\-*/~^<>%&|?!@#.])?[a-zA-Z$_](?:[\w$-]*[\w$])?)",
                TokenType::new(&["Keyword", "Control"]),
            ),
            Rule::bygroups(
                r#"(?m)([a-zA-Z$_](?:[\w$-]*[\w$])?)(?!\n)(\s+)(?=[\'"\d{\[(])"#,
                vec![
                    Some(TokenType::new(&["Keyword", "Control"])),
                    Some(WHITESPACE),
                ],
            ),
            Rule::bygroups(
    ...
    m.insert(
        ...
        vec![
            ...
            Rule::bygroups(
                ...
                ([a-zA-Z$_](?:[\w$-]*[\w$])?)
                (?=[}\]).,;:\s])",
                vec![Some(PUNCTUATION), Some(TokenType::new(&["Name", "Field"]))],
            ),
            Rule::bygroups(
                r"(?m)(?x)
                (?<=[\w$\]})])(\.)
    ...
    m.insert(
        ...
        vec![
            ...
            Rule::bygroups(
                r"(?m)([a-zA-Z$_](?:[\w$-]*[\w$])?)(\+\+|\-\-)?",
                vec![
                    Some(TokenType::new(&["Name", "Symbol"])),
                    Some(OPERATOR_WORD),
                ],
            ),
        ],
    ...
    m.insert(
        ...
        vec![
            ...
            Rule::token(r"(?m)16r[a-fA-F0-9]+", NUMBER_HEX),
            Rule::token(
                r"(?m)([3-79]|[12][0-9]|3[0-6])r[a-zA-Z\d]+(\.[a-zA-Z\d]+)?",
                TokenType::new(&["Literal", "Number", "Radix"]),
            ),
            Rule::token(r"(?m)\d+", NUMBER_INTEGER),
        ],
    );
    m.insert(
        ...
        vec![
            Rule::bygroups(
                ...
                vec![
                    Some(PUNCTUATION),
                    Some(TokenType::new(&["Name", "Class", "DBS"])),
                ],
            ),
            Rule::bygroups(
                r"(?m)(\[)([\^#][a-zA-Z$_](?:[\w$\-]*[\w$])?)(\])",
                vec![
                    Some(PUNCTUATION),
                    Some(TokenType::new(&["Name", "Entity", "DBS"])),
                    Some(PUNCTUATION),
                ],
            ),
