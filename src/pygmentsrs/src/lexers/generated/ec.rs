//! AUTO-GENERATED from `pygments.pygments.lexers.c_like:ECLexer`.
//!
//! Do not edit by hand. Regenerate with:
//!   python tools/gen_lexer.py pygments.lexers.c_like:ECLexer:ec
...
fn build_table() -> Table {
    ...
    m.insert(r"statements", vec![
        Rule::token(r"(?m)(__on_register_module|any_object|class(?:(?:_(?:d(?:ata|e(?:fault_property|signer))|fixed|no_expansion|property))?)|d(?:atabase_open|b(?:field|index|table)|e(?:(?:fin|let)e)|ll(?:(?:ex|im)port))|firewatchers|get|i(?:mport|ncref|sset)|n(?:amespace|ew(?:(?:0)?))|p(?:r(?:ivate|operty(?:(?:_category)?))|ublic)|re(?:gister|mote|new(?:(?:0)?))|s(?:et|t(?:dcall|opwatching)|ubclass)|t(?:hisclass|yped_object)|using|virtual|watch(?:(?:able)?))\b", KEYWORD),
        Rule::token(r"(?m)(b(?:ool|yte)|int64|u(?:int(?:(?:16|32|64)?)|nichar))\b", KEYWORD_TYPE),
        Rule::bygroups_to(r"(?m)(class)(\s+)", vec![Some(KEYWORD), Some(WHITESPACE)], NewState::Push(vec![r"classname"])),
        Rule::token(r"(?m)(null|value|this)\b", NAME_BUILTIN),
