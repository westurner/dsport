...
fn build_table() -> Table {
    ...
    m.insert(
        ...
        vec![
            ...
            Rule::bygroups_to(
                r"(?m)^([0-9A-Ha-h]+)(:)",
                vec![Some(NAME_LABEL), Some(PUNCTUATION)],
                NewState::Push(vec![r"offset-mode"]),
            ),
            Rule::token(r"(?m)^[0-9A-Ha-h]+", NAME_LABEL),
            Rule::bygroups(
                r"(?m)([0-9A-Ha-h]{2})(\-)([0-9A-Ha-h]{2})",
                vec![Some(NUMBER_HEX), Some(PUNCTUATION), Some(NUMBER_HEX)],
            ),
            ...
            Rule::bygroups_to(
                ...
                NewState::Push(vec![r"bracket-strings"]),
            ),
            Rule::bygroups_to(
                r"(?m)(\s{2,3})(\|)(.{16})(\|)$",
                vec![
                ...
                NewState::Push(vec![r"piped-strings"]),
            ),
            Rule::bygroups(
                r"(?m)(\s{2,3})(\>)(.{1,15})(\<)$",
                vec![
            ...
            Rule::bygroups_to(
                r"(?m)(\s{2,3})(.{16}|.{20})$",
                vec![Some(WHITESPACE), Some(STRING)],
                NewState::Push(vec![r"nonpiped-strings"]),
            ),
