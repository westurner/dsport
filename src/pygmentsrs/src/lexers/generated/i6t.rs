//! AUTO-GENERATED from `pygments.pygments.lexers.int_fiction:Inform6TemplateLexer`.
//!
//! Do not edit by hand. Regenerate with:
//!   python tools/gen_lexer.py pygments.lexers.int_fiction:Inform6TemplateLexer:i6t
...
fn build_table() -> Table {
    ...
    m.insert(r"+i6-root", vec![
        Rule::token_to(r"(?ms)\A(!%[^\n  ]*[\n  ])+", COMMENT_PREPROC, NewState::Push(vec![r"directive"])),
        Rule::default(NewState::Push(vec![r"directive"])),
    ]);
    m.insert(r"+i6t-root", vec![
        Rule::token_to(r"(?ms)[^\n  ]*", COMMENT_PREPROC, NewState::Push(vec![r"directive", r"+p"])),
    ]);
    m.insert(r"root", vec![
        Rule::token(r"(?ms)(\|?\s)+", TEXT),
        Rule::token_to(r"(?ms)\[", COMMENT_MULTILINE, NewState::Push(vec![r"+comment"])),
        Rule::token_to(r#"(?ms)["“”]"#, GENERIC_HEADING, NewState::Push(vec![r"+main", r"+titling", r"+titling-string"])),
        Rule::default(NewState::Push(vec![r"+main", r"+heading?"])),
    ]);
    m.insert(r"+titling-string", vec![
        Rule::token(r#"(?ms)[^"“”]+"#, GENERIC_HEADING),
        Rule::token_to(r#"(?ms)["“”]"#, GENERIC_HEADING, NewState::Pop(1)),
    ]);
    m.insert(r"+titling", vec![
        Rule::token_to(r"(?ms)\[", COMMENT_MULTILINE, NewState::Push(vec![r"+comment"])),
        Rule::token(r#"(?ms)[^"“”.;:|\n  ]+"#, GENERIC_HEADING),
        Rule::token_to(r#"(?ms)["“”]"#, GENERIC_HEADING, NewState::Push(vec![r"+titling-string"])),
        Rule::token_to(r#"(?ms)[\n  ]{2}|(?<=[\s"“”])\|[\s"“”]"#, TEXT, NewState::Push(vec![r"#pop", r"+heading?"])),
        Rule::token_to(r#"(?ms)[.;:]|(?<=[\s"“”])\|"#, TEXT, NewState::Pop(1)),
        Rule::token(r"(?ms)[|\n  ]", GENERIC_HEADING),
    ]);
    m.insert(r"+main", vec![
        Rule::token(r#"(?ms)(?i)[^"“”:a\[(|\n  ]+"#, TEXT),
        Rule::token_to(r#"(?ms)["“”]"#, STRING_DOUBLE, NewState::Push(vec![r"+text"])),
        Rule::token_to(r"(?ms):", TEXT, NewState::Push(vec![r"+phrase-definition"])),
        Rule::token_to(r"(?ms)(?i)\bas\b", TEXT, NewState::Push(vec![r"+use-option"])),
        Rule::token_to(r"(?ms)\[", COMMENT_MULTILINE, NewState::Push(vec![r"+comment"])),
        Rule::bygroups_g(r"(?ms)(\([\-‐-—])(.*?)([\-‐-—]\))", vec![Some(GroupAction::Token(PUNCTUATION)), Some(GroupAction::UsingThis { state: Some(vec!["+i6-root", "directive"]) }), Some(GroupAction::Token(PUNCTUATION))]),
        Rule::token_to(r#"(?ms)(\A|(?<=[\n  ])|(?<=[\s;:."“”]))\|\s|[\n  ]{2,}"#, TEXT, NewState::Push(vec![r"+heading?"])),
        Rule::token(r"(?ms)(?i)[a(|\n  ]", TEXT),
    ]);
    m.insert(r"+phrase-definition", vec![
        Rule::token(r"(?ms)\s+", TEXT),
        Rule::token_to(r"(?ms)\[", COMMENT_MULTILINE, NewState::Push(vec![r"+comment"])),
        Rule::bygroups_g_to(r"(?ms)(\([\-‐-—])(.*?)([\-‐-—]\))", vec![Some(GroupAction::Token(PUNCTUATION)), Some(GroupAction::UsingThis { state: Some(vec!["+i6-root", "directive", "default", "statements"]) }), Some(GroupAction::Token(PUNCTUATION))], NewState::Pop(1)),
        Rule::default(NewState::Pop(1)),
    ]);
    m.insert(r"+use-option", vec![
        Rule::token(r"(?ms)\s+", TEXT),
        Rule::token_to(r"(?ms)\[", COMMENT_MULTILINE, NewState::Push(vec![r"+comment"])),
        Rule::bygroups_g_to(r"(?ms)(\([\-‐-—])(.*?)([\-‐-—]\))", vec![Some(GroupAction::Token(PUNCTUATION)), Some(GroupAction::UsingThis { state: Some(vec!["+i6-root", "directive"]) }), Some(GroupAction::Token(PUNCTUATION))], NewState::Pop(1)),
        Rule::default(NewState::Pop(1)),
    ]);
    ...
    m.insert(r"+heading?", vec![
        Rule::token(r"(?ms)(\|?\s)+", TEXT),
        Rule::token_to(r"(?ms)\[", COMMENT_MULTILINE, NewState::Push(vec![r"+comment"])),
        Rule::token_to(r"(?ms)[\-‐-—]{4}\s+", TEXT, NewState::Push(vec![r"+documentation-heading"])),
        Rule::token(r"(?ms)[\-‐-—]{1,3}", TEXT),
        Rule::token_to(r"(?ms)(?i)(volume|book|part|chapter|section)\b[^\n  ]*", GENERIC_HEADING, NewState::Pop(1)),
        Rule::default(NewState::Pop(1)),
    ]);
    m.insert(r"+documentation-heading", vec![
        Rule::token(r"(?ms)\s+", TEXT),
        Rule::token_to(r"(?ms)\[", COMMENT_MULTILINE, NewState::Push(vec![r"+comment"])),
        Rule::token_to(r"(?ms)(?i)documentation\s+", TEXT, NewState::Push(vec![r"+documentation-heading2"])),
        Rule::default(NewState::Pop(1)),
    ]);
    m.insert(r"+documentation-heading2", vec![
        Rule::token(r"(?ms)\s+", TEXT),
        Rule::token_to(r"(?ms)\[", COMMENT_MULTILINE, NewState::Push(vec![r"+comment"])),
        Rule::token_to(r"(?ms)[\-‐-—]{4}\s", TEXT, NewState::Push(vec![r"+documentation"])),
        Rule::default(NewState::Pop(2)),
    ]);
    m.insert(r"+documentation", vec![
        Rule::token(r"(?ms)(?i)(\A|(?<=[\n  ]))\s*(chapter|example)\s*:[^\n  ]*", GENERIC_HEADING),
        Rule::token(r"(?ms)(?i)(\A|(?<=[\n  ]))\s*section\s*:[^\n  ]*", GENERIC_SUBHEADING),
        Rule::using_this(r"(?ms)((\A|(?<=[\n  ]))\t.*?[\n  ])+", Some(vec!["root", "+main"])),
        Rule::token(r"(?ms)[^\n  \[]+|[\n  \[]", TEXT),
        Rule::token_to(r"(?ms)\[", COMMENT_MULTILINE, NewState::Push(vec![r"+comment"])),
    ]);
    m.insert(r"+i6t-not-inline", vec![
        Rule::token(r"(?ms)(\A|(?<=[\n  ]))@c( .*?)?([\n  ]|\Z)", COMMENT_PREPROC),
        Rule::token(r"(?ms)(\A|(?<=[\n  ]))@([\-‐-—]+|Purpose:)[^\n  ]*", COMMENT_PREPROC),
        Rule::token_to(r"(?ms)(\A|(?<=[\n  ]))@p( .*?)?([\n  ]|\Z)", GENERIC_HEADING, NewState::Push(vec![r"+p"])),
    ]);
    m.insert(r"+i6t-use-option", vec![
        Rule::token(r"(?ms)(\A|(?<=[\n  ]))@c( .*?)?([\n  ]|\Z)", COMMENT_PREPROC),
        Rule::token(r"(?ms)(\A|(?<=[\n  ]))@([\-‐-—]+|Purpose:)[^\n  ]*", COMMENT_PREPROC),
        Rule::token_to(r"(?ms)(\A|(?<=[\n  ]))@p( .*?)?([\n  ]|\Z)", GENERIC_HEADING, NewState::Push(vec![r"+p"])),
        Rule::bygroups(r"(?ms)(\{)(N)(\})", vec![Some(PUNCTUATION), Some(TEXT), Some(PUNCTUATION)]),
    ]);
    m.insert(r"+i6t-inline", vec![
        Rule::bygroups_g(r"(?ms)(\{)(\S[^}]*)?(\})", vec![Some(GroupAction::Token(PUNCTUATION)), Some(GroupAction::UsingThis { state: Some(vec!["root", "+main"]) }), Some(GroupAction::Token(PUNCTUATION))]),
    ]);
    m.insert(r"+i6t", vec![
    ...
    m.insert(r"+p", vec![
        ...
        Rule::token_to(r"(?ms)(\A|(?<=[\n  ]))@c( .*?)?([\n  ]|\Z)", COMMENT_PREPROC, NewState::Pop(1)),
        Rule::token(r"(?ms)(\A|(?<=[\n  ]))@([\-‐-—]|Purpose:)", COMMENT_PREPROC),
        Rule::token(r"(?ms)(\A|(?<=[\n  ]))@p( .*?)?([\n  ]|\Z)", GENERIC_HEADING),
        Rule::token(r"(?ms)@", COMMENT_PREPROC),
    ]);
    m.insert(r"+lines", vec![
        Rule::token(r"(?ms)(\A|(?<=[\n  ]))@c( .*?)?([\n  ]|\Z)", COMMENT_PREPROC),
        Rule::token(r"(?ms)(\A|(?<=[\n  ]))@([\-‐-—]|Purpose:)[^\n  ]*", COMMENT_PREPROC),
        Rule::token_to(r"(?ms)(\A|(?<=[\n  ]))@p( .*?)?([\n  ]|\Z)", GENERIC_HEADING, NewState::Push(vec![r"+p"])),
        Rule::token(r"(?ms)(\A|(?<=[\n  ]))@\w*[ \n  ]", KEYWORD),
        Rule::token(r"(?ms)![^\n  ]*", COMMENT_SINGLE),
        Rule::bygroups_to(r"(?ms)(\{)([\-‐-—]endlines)(\})", vec![Some(PUNCTUATION), Some(KEYWORD), Some(PUNCTUATION)], NewState::Pop(1)),
        Rule::token(r"(?ms)[^@!{]+?([\n  ]|\Z)|.", TEXT),
    ]);
    m.insert(r"_whitespace", vec![
        Rule::token(r"(?ms)\s+", TEXT),
        Rule::token(r"(?ms)![^\n  ]*", COMMENT_SINGLE),
    ]);
    m.insert(r"default", vec![
        ...
        Rule::token(r"(?ms)\s+", TEXT),
        Rule::token(r"(?ms)![^\n  ]*", COMMENT_SINGLE),
        Rule::token_to(r"(?ms)\[", PUNCTUATION, NewState::Push(vec![r"many-values"])),
    ...
    m.insert(r"_expression", vec![
        Rule::token(r"(?ms)\s+", TEXT),
        Rule::token(r"(?ms)![^\n  ]*", COMMENT_SINGLE),
        Rule::token_to(r"(?ms)(?=sp\b)", TEXT, NewState::Pop(1)),
        Rule::token_to(r#"(?ms)(?=["“”'‘’$0-9#a-zA-Z_])"#, TEXT, NewState::Push(vec![r"#pop", r"value"])),
    ...
    m.insert(r"expression", vec![
        ...
        Rule::token(r"(?ms)\s+", TEXT),
        Rule::token(r"(?ms)![^\n  ]*", COMMENT_SINGLE),
        Rule::token_to(r"(?ms)\(", PUNCTUATION, NewState::Push(vec![r"expression", r"_expression"])),
        Rule::token_to(r"(?ms)\)", PUNCTUATION, NewState::Pop(1)),
        Rule::token_to(r"(?ms)\[", PUNCTUATION, NewState::Push(vec![r"#pop", r"statements", r"locals"])),
        Rule::token(r"(?ms)>(?=(\s+|(![^\n  ]*))*[>;])", PUNCTUATION),
        Rule::token(r"(?ms)\+\+|[\-‐-—]{2}(?!>)", OPERATOR),
        Rule::token_to(r"(?ms),", PUNCTUATION, NewState::Push(vec![r"_expression"])),
        Rule::token_to(r"(?ms)&&?|\|\|?|[=~><]?=|[\-‐-—]{1,2}>?|\.\.?[&#]?|::|[<>+*/%]", OPERATOR, NewState::Push(vec![r"_expression"])),
        Rule::token_to(r"(?ms)(has|hasnt|in|notin|ofclass|or|provides)\b", OPERATOR_WORD, NewState::Push(vec![r"_expression"])),
        Rule::token(r"(?ms)sp\b", NAME),
        Rule::token_to(r"(?ms)\?~?", NAME_LABEL, NewState::Push(vec![r"label?"])),
        Rule::token(r"(?ms)[@{]", ERROR),
        Rule::default(NewState::Pop(1)),
    ]);
    m.insert(r"_assembly-expression", vec![
        Rule::token_to(r"(?ms)\(", PUNCTUATION, NewState::Push(vec![r"#push", r"_expression"])),
        Rule::token(r"(?ms)[\[\]]", PUNCTUATION),
        Rule::token_to(r"(?ms)[\-‐-—]>", PUNCTUATION, NewState::Push(vec![r"_expression"])),
    ...
    m.insert(r"_for-expression", vec![
    ...
    m.insert(r"_keyword-expression", vec![
        Rule::token_to(r"(?ms)(from|near|to)\b", KEYWORD, NewState::Push(vec![r"_expression"])),
        Rule::bygroups(r"(?ms)(\{[\-‐-—])(![^}]*)(\}?)", vec![Some(PUNCTUATION), Some(COMMENT_SINGLE), Some(PUNCTUATION)]),
        Rule::bygroups_to(r"(?ms)(\{[\-‐-—])(lines)(:)([^}]*)(\}?)", vec![Some(PUNCTUATION), Some(KEYWORD), Some(PUNCTUATION), Some(TEXT), Some(PUNCTUATION)], NewState::Push(vec![r"+lines"])),
        Rule::bygroups(r"(?ms)(\{[\-‐-—])([^:}]*)(:?)([^}]*)(\}?)", vec![Some(PUNCTUATION), Some(KEYWORD), Some(PUNCTUATION), Some(TEXT), Some(PUNCTUATION)]),
        Rule::bygroups_g(r"(?ms)(\(\+)(.*?)(\+\)|\Z)", vec![Some(GroupAction::Token(PUNCTUATION)), Some(GroupAction::UsingThis { state: Some(vec!["root", "+main"]) }), Some(GroupAction::Token(PUNCTUATION))]),
    ...
    m.insert(r"_list-expression", vec![
        Rule::token_to(r"(?ms),", PUNCTUATION, NewState::Pop(1)),
        Rule::bygroups(r"(?ms)(\{[\-‐-—])(![^}]*)(\}?)", vec![Some(PUNCTUATION), Some(COMMENT_SINGLE), Some(PUNCTUATION)]),
        Rule::bygroups_to(r"(?ms)(\{[\-‐-—])(lines)(:)([^}]*)(\}?)", vec![Some(PUNCTUATION), Some(KEYWORD), Some(PUNCTUATION), Some(TEXT), Some(PUNCTUATION)], NewState::Push(vec![r"+lines"])),
        Rule::bygroups(r"(?ms)(\{[\-‐-—])([^:}]*)(:?)([^}]*)(\}?)", vec![Some(PUNCTUATION), Some(KEYWORD), Some(PUNCTUATION), Some(TEXT), Some(PUNCTUATION)]),
    ...
    m.insert(r"_object-expression", vec![
    ...
    m.insert(r"dictionary-word", vec![
        Rule::bygroups(r"(?ms)(\{[\-‐-—])(![^}]*)(\}?)", vec![Some(PUNCTUATION), Some(COMMENT_SINGLE), Some(PUNCTUATION)]),
        Rule::bygroups_to(r"(?ms)(\{[\-‐-—])(lines)(:)([^}]*)(\}?)", vec![Some(PUNCTUATION), Some(KEYWORD), Some(PUNCTUATION), Some(TEXT), Some(PUNCTUATION)], NewState::Push(vec![r"+lines"])),
        Rule::bygroups(r"(?ms)(\{[\-‐-—])([^:}]*)(:?)([^}]*)(\}?)", vec![Some(PUNCTUATION), Some(KEYWORD), Some(PUNCTUATION), Some(TEXT), Some(PUNCTUATION)]),
        Rule::bygroups_g(r"(?ms)(\(\+)(.*?)(\+\)|\Z)", vec![Some(GroupAction::Token(PUNCTUATION)), Some(GroupAction::UsingThis { state: Some(vec!["root", "+main"]) }), Some(GroupAction::Token(PUNCTUATION))]),
    ...
    m.insert(r"constant*", vec![
        ...
        Rule::token_to(r"(?ms)[a-zA-Z_]\w*", NAME_CONSTANT, NewState::Push(vec![r"value?"])),
        Rule::default(NewState::Pop(1)),
    ]);
    ...
    m.insert(r"obsolete-dictionary-word", vec![
        Rule::bygroups(r"(?ms)(\{[\-‐-—])(![^}]*)(\}?)", vec![Some(PUNCTUATION), Some(COMMENT_SINGLE), Some(PUNCTUATION)]),
        Rule::bygroups_to(r"(?ms)(\{[\-‐-—])(lines)(:)([^}]*)(\}?)", vec![Some(PUNCTUATION), Some(KEYWORD), Some(PUNCTUATION), Some(TEXT), Some(PUNCTUATION)], NewState::Push(vec![r"+lines"])),
        Rule::bygroups(r"(?ms)(\{[\-‐-—])([^:}]*)(:?)([^}]*)(\}?)", vec![Some(PUNCTUATION), Some(KEYWORD), Some(PUNCTUATION), Some(TEXT), Some(PUNCTUATION)]),
        Rule::bygroups_g(r"(?ms)(\(\+)(.*?)(\+\)|\Z)", vec![Some(GroupAction::Token(PUNCTUATION)), Some(GroupAction::UsingThis { state: Some(vec!["root", "+main"]) }), Some(GroupAction::Token(PUNCTUATION))]),
    ...
    m.insert(r"system-constant", vec![
        Rule::bygroups(r"(?ms)(\{[\-‐-—])(![^}]*)(\}?)", vec![Some(PUNCTUATION), Some(COMMENT_SINGLE), Some(PUNCTUATION)]),
        Rule::bygroups_to(r"(?ms)(\{[\-‐-—])(lines)(:)([^}]*)(\}?)", vec![Some(PUNCTUATION), Some(KEYWORD), Some(PUNCTUATION), Some(TEXT), Some(PUNCTUATION)], NewState::Push(vec![r"+lines"])),
        Rule::bygroups(r"(?ms)(\{[\-‐-—])([^:}]*)(:?)([^}]*)(\}?)", vec![Some(PUNCTUATION), Some(KEYWORD), Some(PUNCTUATION), Some(TEXT), Some(PUNCTUATION)]),
        Rule::bygroups_g(r"(?ms)(\(\+)(.*?)(\+\)|\Z)", vec![Some(GroupAction::Token(PUNCTUATION)), Some(GroupAction::UsingThis { state: Some(vec!["root", "+main"]) }), Some(GroupAction::Token(PUNCTUATION))]),
    ...
    m.insert(r"locals", vec![
        ...
        Rule::token_to(r"(?ms);", PUNCTUATION, NewState::Pop(1)),
        Rule::token(r"(?ms)\*", PUNCTUATION),
        Rule::token_to(r#"(?ms)""#, STRING_DOUBLE, NewState::Push(vec![r"plain-string"])),
        Rule::token(r"(?ms)[a-zA-Z_]\w*", NAME_VARIABLE),
    ]);
    m.insert(r"many-values", vec![
        Rule::bygroups(r"(?ms)(\{[\-‐-—])(![^}]*)(\}?)", vec![Some(PUNCTUATION), Some(COMMENT_SINGLE), Some(PUNCTUATION)]),
        Rule::bygroups_to(r"(?ms)(\{[\-‐-—])(lines)(:)([^}]*)(\}?)", vec![Some(PUNCTUATION), Some(KEYWORD), Some(PUNCTUATION), Some(TEXT), Some(PUNCTUATION)], NewState::Push(vec![r"+lines"])),
        Rule::bygroups(r"(?ms)(\{[\-‐-—])([^:}]*)(:?)([^}]*)(\}?)", vec![Some(PUNCTUATION), Some(KEYWORD), Some(PUNCTUATION), Some(TEXT), Some(PUNCTUATION)]),
        Rule::bygroups_g(r"(?ms)(\(\+)(.*?)(\+\)|\Z)", vec![Some(GroupAction::Token(PUNCTUATION)), Some(GroupAction::UsingThis { state: Some(vec!["root", "+main"]) }), Some(GroupAction::Token(PUNCTUATION))]),
    ...
    m.insert(r"alias?", vec![
        ...
        Rule::token(r"(?ms)\s+", TEXT),
        Rule::token(r"(?ms)![^\n  ]*", COMMENT_SINGLE),
        Rule::token_to(r"(?ms)alias\b", KEYWORD, NewState::Push(vec![r"#pop", r"_constant"])),
        Rule::default(NewState::Pop(1)),
    ]);
    m.insert(r"class-name", vec![
        Rule::bygroups(r"(?ms)(\{[\-‐-—])(![^}]*)(\}?)", vec![Some(PUNCTUATION), Some(COMMENT_SINGLE), Some(PUNCTUATION)]),
        Rule::bygroups_to(r"(?ms)(\{[\-‐-—])(lines)(:)([^}]*)(\}?)", vec![Some(PUNCTUATION), Some(KEYWORD), Some(PUNCTUATION), Some(TEXT), Some(PUNCTUATION)], NewState::Push(vec![r"+lines"])),
        Rule::bygroups(r"(?ms)(\{[\-‐-—])([^:}]*)(:?)([^}]*)(\}?)", vec![Some(PUNCTUATION), Some(KEYWORD), Some(PUNCTUATION), Some(TEXT), Some(PUNCTUATION)]),
        Rule::bygroups_g(r"(?ms)(\(\+)(.*?)(\+\)|\Z)", vec![Some(GroupAction::Token(PUNCTUATION)), Some(GroupAction::UsingThis { state: Some(vec!["root", "+main"]) }), Some(GroupAction::Token(PUNCTUATION))]),
        ...
        Rule::token(r"(?ms)\s+", TEXT),
        Rule::token(r"(?ms)![^\n  ]*", COMMENT_SINGLE),
        Rule::token_to(r"(?ms)(?=[,;]|(class|has|private|with)\b)", TEXT, NewState::Pop(1)),
        Rule::token_to(r"(?ms)[a-zA-Z_]\w*", NAME_CLASS, NewState::Pop(1)),
    ]);
    m.insert(r"duplicates", vec![
        Rule::bygroups(r"(?ms)(\{[\-‐-—])(![^}]*)(\}?)", vec![Some(PUNCTUATION), Some(COMMENT_SINGLE), Some(PUNCTUATION)]),
        Rule::bygroups_to(r"(?ms)(\{[\-‐-—])(lines)(:)([^}]*)(\}?)", vec![Some(PUNCTUATION), Some(KEYWORD), Some(PUNCTUATION), Some(TEXT), Some(PUNCTUATION)], NewState::Push(vec![r"+lines"])),
        Rule::bygroups(r"(?ms)(\{[\-‐-—])([^:}]*)(:?)([^}]*)(\}?)", vec![Some(PUNCTUATION), Some(KEYWORD), Some(PUNCTUATION), Some(TEXT), Some(PUNCTUATION)]),
        Rule::bygroups_g(r"(?ms)(\(\+)(.*?)(\+\)|\Z)", vec![Some(GroupAction::Token(PUNCTUATION)), Some(GroupAction::UsingThis { state: Some(vec!["root", "+main"]) }), Some(GroupAction::Token(PUNCTUATION))]),
        ...
        Rule::token(r"(?ms)\s+", TEXT),
        Rule::token(r"(?ms)![^\n  ]*", COMMENT_SINGLE),
        Rule::token_to(r"(?ms)\(", PUNCTUATION, NewState::Push(vec![r"#pop", r"expression", r"_expression"])),
        Rule::default(NewState::Pop(1)),
    ]);
    ...
    m.insert(r"grammar", vec![
        ...
        Rule::token(r"(?ms)\s+", TEXT),
        Rule::token(r"(?ms)![^\n  ]*", COMMENT_SINGLE),
        Rule::token_to(r"(?ms)=", PUNCTUATION, NewState::Push(vec![r"#pop", r"default"])),
        Rule::token_to(r"(?ms)\*", PUNCTUATION, NewState::Push(vec![r"#pop", r"grammar-line"])),
        Rule::default(NewState::Push(vec![r"_directive-keyword"])),
    ]);
    m.insert(r"grammar-line", vec![
        Rule::bygroups(r"(?ms)(\{[\-‐-—])(![^}]*)(\}?)", vec![Some(PUNCTUATION), Some(COMMENT_SINGLE), Some(PUNCTUATION)]),
        Rule::bygroups_to(r"(?ms)(\{[\-‐-—])(lines)(:)([^}]*)(\}?)", vec![Some(PUNCTUATION), Some(KEYWORD), Some(PUNCTUATION), Some(TEXT), Some(PUNCTUATION)], NewState::Push(vec![r"+lines"])),
        Rule::bygroups(r"(?ms)(\{[\-‐-—])([^:}]*)(:?)([^}]*)(\}?)", vec![Some(PUNCTUATION), Some(KEYWORD), Some(PUNCTUATION), Some(TEXT), Some(PUNCTUATION)]),
        Rule::bygroups_g(r"(?ms)(\(\+)(.*?)(\+\)|\Z)", vec![Some(GroupAction::Token(PUNCTUATION)), Some(GroupAction::UsingThis { state: Some(vec!["root", "+main"]) }), Some(GroupAction::Token(PUNCTUATION))]),
        ...
        Rule::token(r"(?ms)[/*]", PUNCTUATION),
        Rule::token_to(r"(?ms)[\-‐-—]>", PUNCTUATION, NewState::Push(vec![r"value"])),
        Rule::token_to(r"(?ms)(noun|scope)\b", KEYWORD, NewState::Push(vec![r"=routine"])),
        Rule::default(NewState::Push(vec![r"_directive-keyword"])),
    ]);
    m.insert(r"=routine", vec![
        Rule::bygroups(r"(?ms)(\{[\-‐-—])(![^}]*)(\}?)", vec![Some(PUNCTUATION), Some(COMMENT_SINGLE), Some(PUNCTUATION)]),
        Rule::bygroups_to(r"(?ms)(\{[\-‐-—])(lines)(:)([^}]*)(\}?)", vec![Some(PUNCTUATION), Some(KEYWORD), Some(PUNCTUATION), Some(TEXT), Some(PUNCTUATION)], NewState::Push(vec![r"+lines"])),
        Rule::bygroups(r"(?ms)(\{[\-‐-—])([^:}]*)(:?)([^}]*)(\}?)", vec![Some(PUNCTUATION), Some(KEYWORD), Some(PUNCTUATION), Some(TEXT), Some(PUNCTUATION)]),
        Rule::bygroups_g(r"(?ms)(\(\+)(.*?)(\+\)|\Z)", vec![Some(GroupAction::Token(PUNCTUATION)), Some(GroupAction::UsingThis { state: Some(vec!["root", "+main"]) }), Some(GroupAction::Token(PUNCTUATION))]),
        ...
        Rule::token(r"(?ms)\s+", TEXT),
        Rule::token(r"(?ms)![^\n  ]*", COMMENT_SINGLE),
        Rule::token_to(r"(?ms)=", PUNCTUATION, NewState::Push(vec![r"routine-name?"])),
        Rule::default(NewState::Pop(1)),
    ]);
    m.insert(r"manifest", vec![
        Rule::bygroups(r"(?ms)(\{[\-‐-—])(![^}]*)(\}?)", vec![Some(PUNCTUATION), Some(COMMENT_SINGLE), Some(PUNCTUATION)]),
        Rule::bygroups_to(r"(?ms)(\{[\-‐-—])(lines)(:)([^}]*)(\}?)", vec![Some(PUNCTUATION), Some(KEYWORD), Some(PUNCTUATION), Some(TEXT), Some(PUNCTUATION)], NewState::Push(vec![r"+lines"])),
        Rule::bygroups(r"(?ms)(\{[\-‐-—])([^:}]*)(:?)([^}]*)(\}?)", vec![Some(PUNCTUATION), Some(KEYWORD), Some(PUNCTUATION), Some(TEXT), Some(PUNCTUATION)]),
        Rule::bygroups_g(r"(?ms)(\(\+)(.*?)(\+\)|\Z)", vec![Some(GroupAction::Token(PUNCTUATION)), Some(GroupAction::UsingThis { state: Some(vec!["root", "+main"]) }), Some(GroupAction::Token(PUNCTUATION))]),
        ...
        Rule::token_to(r"(?ms);", PUNCTUATION, NewState::Pop(1)),
        Rule::token(r"(?ms),", PUNCTUATION),
        Rule::token_to(r"(?ms)(?i)global\b", KEYWORD, NewState::Push(vec![r"_global"])),
        Rule::default(NewState::Push(vec![r"_global"])),
    ]);
    m.insert(r"diagnostic", vec![
        Rule::bygroups(r"(?ms)(\{[\-‐-—])(![^}]*)(\}?)", vec![Some(PUNCTUATION), Some(COMMENT_SINGLE), Some(PUNCTUATION)]),
        Rule::bygroups_to(r"(?ms)(\{[\-‐-—])(lines)(:)([^}]*)(\}?)", vec![Some(PUNCTUATION), Some(KEYWORD), Some(PUNCTUATION), Some(TEXT), Some(PUNCTUATION)], NewState::Push(vec![r"+lines"])),
        Rule::bygroups(r"(?ms)(\{[\-‐-—])([^:}]*)(:?)([^}]*)(\}?)", vec![Some(PUNCTUATION), Some(KEYWORD), Some(PUNCTUATION), Some(TEXT), Some(PUNCTUATION)]),
        Rule::bygroups_g(r"(?ms)(\(\+)(.*?)(\+\)|\Z)", vec![Some(GroupAction::Token(PUNCTUATION)), Some(GroupAction::UsingThis { state: Some(vec!["root", "+main"]) }), Some(GroupAction::Token(PUNCTUATION))]),
        ...
        Rule::token(r"(?ms)\s+", TEXT),
        Rule::token(r"(?ms)![^\n  ]*", COMMENT_SINGLE),
        Rule::token_to(r#"(?ms)["“”]"#, STRING_DOUBLE, NewState::Push(vec![r"#pop", r"message-string"])),
        Rule::default(NewState::Push(vec![r"#pop", r"before-plain-string?", r"directive-keyword?"])),
    ]);
    m.insert(r"before-plain-string?", vec![
        Rule::bygroups(r"(?ms)(\{[\-‐-—])(![^}]*)(\}?)", vec![Some(PUNCTUATION), Some(COMMENT_SINGLE), Some(PUNCTUATION)]),
        Rule::bygroups_to(r"(?ms)(\{[\-‐-—])(lines)(:)([^}]*)(\}?)", vec![Some(PUNCTUATION), Some(KEYWORD), Some(PUNCTUATION), Some(TEXT), Some(PUNCTUATION)], NewState::Push(vec![r"+lines"])),
        Rule::bygroups(r"(?ms)(\{[\-‐-—])([^:}]*)(:?)([^}]*)(\}?)", vec![Some(PUNCTUATION), Some(KEYWORD), Some(PUNCTUATION), Some(TEXT), Some(PUNCTUATION)]),
        Rule::bygroups_g(r"(?ms)(\(\+)(.*?)(\+\)|\Z)", vec![Some(GroupAction::Token(PUNCTUATION)), Some(GroupAction::UsingThis { state: Some(vec!["root", "+main"]) }), Some(GroupAction::Token(PUNCTUATION))]),
        ...
        Rule::token(r"(?ms)\s+", TEXT),
        Rule::token(r"(?ms)![^\n  ]*", COMMENT_SINGLE),
        Rule::token_to(r#"(?ms)["“”]"#, STRING_DOUBLE, NewState::Push(vec![r"#pop", r"plain-string"])),
        Rule::default(NewState::Pop(1)),
    ]);
    m.insert(r"message-string", vec![
        Rule::bygroups(r"(?ms)(\{[\-‐-—])(![^}]*)(\}?)", vec![Some(PUNCTUATION), Some(COMMENT_SINGLE), Some(PUNCTUATION)]),
        Rule::bygroups_to(r"(?ms)(\{[\-‐-—])(lines)(:)([^}]*)(\}?)", vec![Some(PUNCTUATION), Some(KEYWORD), Some(PUNCTUATION), Some(TEXT), Some(PUNCTUATION)], NewState::Push(vec![r"+lines"])),
        Rule::bygroups(r"(?ms)(\{[\-‐-—])([^:}]*)(:?)([^}]*)(\}?)", vec![Some(PUNCTUATION), Some(KEYWORD), Some(PUNCTUATION), Some(TEXT), Some(PUNCTUATION)]),
        Rule::bygroups_g(r"(?ms)(\(\+)(.*?)(\+\)|\Z)", vec![Some(GroupAction::Token(PUNCTUATION)), Some(GroupAction::UsingThis { state: Some(vec!["root", "+main"]) }), Some(GroupAction::Token(PUNCTUATION))]),
    ...
    m.insert(r"property-keyword*", vec![
        Rule::bygroups(r"(?ms)(\{[\-‐-—])(![^}]*)(\}?)", vec![Some(PUNCTUATION), Some(COMMENT_SINGLE), Some(PUNCTUATION)]),
        Rule::bygroups_to(r"(?ms)(\{[\-‐-—])(lines)(:)([^}]*)(\}?)", vec![Some(PUNCTUATION), Some(KEYWORD), Some(PUNCTUATION), Some(TEXT), Some(PUNCTUATION)], NewState::Push(vec![r"+lines"])),
        Rule::bygroups(r"(?ms)(\{[\-‐-—])([^:}]*)(:?)([^}]*)(\}?)", vec![Some(PUNCTUATION), Some(KEYWORD), Some(PUNCTUATION), Some(TEXT), Some(PUNCTUATION)]),
        Rule::bygroups_g(r"(?ms)(\(\+)(.*?)(\+\)|\Z)", vec![Some(GroupAction::Token(PUNCTUATION)), Some(GroupAction::UsingThis { state: Some(vec!["root", "+main"]) }), Some(GroupAction::Token(PUNCTUATION))]),
        ...
        Rule::token(r"(?ms)\s+", TEXT),
        Rule::token(r"(?ms)![^\n  ]*", COMMENT_SINGLE),
        Rule::token(r"(?ms)(additive|individual|long)\b(?=(\s*|(![^\n  ]*[\n  ]))*[_a-zA-Z])", KEYWORD),
        Rule::default(NewState::Pop(1)),
    ]);
    ...
    m.insert(r"for", vec![
        ...
        Rule::token(r"(?ms)\s+", TEXT),
        Rule::token(r"(?ms)![^\n  ]*", COMMENT_SINGLE),
        Rule::token_to(r"(?ms);", PUNCTUATION, NewState::Push(vec![r"_for-expression", r"_expression"])),
        Rule::default(NewState::Push(vec![r"_for-expression", r"_expression"])),
    ]);
    m.insert(r"print-list", vec![
        Rule::bygroups(r"(?ms)(\{[\-‐-—])(![^}]*)(\}?)", vec![Some(PUNCTUATION), Some(COMMENT_SINGLE), Some(PUNCTUATION)]),
        Rule::bygroups_to(r"(?ms)(\{[\-‐-—])(lines)(:)([^}]*)(\}?)", vec![Some(PUNCTUATION), Some(KEYWORD), Some(PUNCTUATION), Some(TEXT), Some(PUNCTUATION)], NewState::Push(vec![r"+lines"])),
        Rule::bygroups(r"(?ms)(\{[\-‐-—])([^:}]*)(:?)([^}]*)(\}?)", vec![Some(PUNCTUATION), Some(KEYWORD), Some(PUNCTUATION), Some(TEXT), Some(PUNCTUATION)]),
        Rule::bygroups_g(r"(?ms)(\(\+)(.*?)(\+\)|\Z)", vec![Some(GroupAction::Token(PUNCTUATION)), Some(GroupAction::UsingThis { state: Some(vec!["root", "+main"]) }), Some(GroupAction::Token(PUNCTUATION))]),
        ...
        Rule::token_to(r"(?ms);", PUNCTUATION, NewState::Pop(1)),
        Rule::token(r"(?ms):", ERROR),
        Rule::default(NewState::Push(vec![r"_list-expression", r"_expression", r"_list-expression", r"form"])),
    ]);
    m.insert(r"form", vec![
        Rule::bygroups(r"(?ms)(\{[\-‐-—])(![^}]*)(\}?)", vec![Some(PUNCTUATION), Some(COMMENT_SINGLE), Some(PUNCTUATION)]),
        Rule::bygroups_to(r"(?ms)(\{[\-‐-—])(lines)(:)([^}]*)(\}?)", vec![Some(PUNCTUATION), Some(KEYWORD), Some(PUNCTUATION), Some(TEXT), Some(PUNCTUATION)], NewState::Push(vec![r"+lines"])),
        ...
        Rule::token(r"(?ms)\s+", TEXT),
        Rule::token(r"(?ms)![^\n  ]*", COMMENT_SINGLE),
        Rule::token_to(r"(?ms)\(", PUNCTUATION, NewState::Push(vec![r"#pop", r"miscellaneous-keyword?"])),
        Rule::default(NewState::Pop(1)),
    ]);
    m.insert(r"opcode", vec![
        Rule::bygroups(r"(?ms)(\{[\-‐-—])(![^}]*)(\}?)", vec![Some(PUNCTUATION), Some(COMMENT_SINGLE), Some(PUNCTUATION)]),
        Rule::bygroups_to(r"(?ms)(\{[\-‐-—])(lines)(:)([^}]*)(\}?)", vec![Some(PUNCTUATION), Some(KEYWORD), Some(PUNCTUATION), Some(TEXT), Some(PUNCTUATION)], NewState::Push(vec![r"+lines"])),
        Rule::bygroups(r"(?ms)(\{[\-‐-—])([^:}]*)(:?)([^}]*)(\}?)", vec![Some(PUNCTUATION), Some(KEYWORD), Some(PUNCTUATION), Some(TEXT), Some(PUNCTUATION)]),
        Rule::bygroups_g(r"(?ms)(\(\+)(.*?)(\+\)|\Z)", vec![Some(GroupAction::Token(PUNCTUATION)), Some(GroupAction::UsingThis { state: Some(vec!["root", "+main"]) }), Some(GroupAction::Token(PUNCTUATION))]),
        ...
        Rule::token(r"(?ms)\s+", TEXT),
        Rule::token(r"(?ms)![^\n  ]*", COMMENT_SINGLE),
        Rule::token_to(r#"(?ms)["“”]"#, STRING_DOUBLE, NewState::Push(vec![r"operands", r"plain-string"])),
        Rule::token_to(r"(?ms)[\-‐-—]{1,2}>", PUNCTUATION, NewState::Push(vec![r"operands"])),
        Rule::token_to(r"(?ms)[a-zA-Z_]\w*", KEYWORD, NewState::Push(vec![r"operands"])),
    ]);
    m.insert(r"operands", vec![
        Rule::bygroups(r"(?ms)(\{[\-‐-—])(![^}]*)(\}?)", vec![Some(PUNCTUATION), Some(COMMENT_SINGLE), Some(PUNCTUATION)]),
        Rule::bygroups_to(r"(?ms)(\{[\-‐-—])(lines)(:)([^}]*)(\}?)", vec![Some(PUNCTUATION), Some(KEYWORD), Some(PUNCTUATION), Some(TEXT), Some(PUNCTUATION)], NewState::Push(vec![r"+lines"])),
        Rule::bygroups(r"(?ms)(\{[\-‐-—])([^:}]*)(:?)([^}]*)(\}?)", vec![Some(PUNCTUATION), Some(KEYWORD), Some(PUNCTUATION), Some(TEXT), Some(PUNCTUATION)]),
        Rule::bygroups_g(r"(?ms)(\(\+)(.*?)(\+\)|\Z)", vec![Some(GroupAction::Token(PUNCTUATION)), Some(GroupAction::UsingThis { state: Some(vec!["root", "+main"]) }), Some(GroupAction::Token(PUNCTUATION))]),
        ...
        Rule::token_to(r"(?ms)(\A|(?<=[\n  ]))@p( .*?)?([\n  ]|\Z)", GENERIC_HEADING, NewState::Push(vec![r"+p"])),
        Rule::token(r"(?ms):", ERROR),
        Rule::default(NewState::Push(vec![r"_assembly-expression", r"_expression"])),
    ]);
    Table(m)
}

impl Lexer for I6tLexer {
