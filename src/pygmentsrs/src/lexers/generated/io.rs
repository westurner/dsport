...
fn build_table() -> Table {
    ...
    m.insert(r"root", vec![
        ...
        Rule::token(r"(?m)(clone|do|doFile|doString|method|for|if|else|elseif|then)\b", KEYWORD),
        Rule::token(r"(?m)(nil|false|true)\b", NAME_CONSTANT),
        Rule::token(r"(?m)(Object|list|List|Map|args|Sequence|Coroutine|File)\b", NAME_BUILTIN),
