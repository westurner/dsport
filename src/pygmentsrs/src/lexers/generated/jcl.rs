...
fn build_table() -> Table {
    ...
    m.insert(
        ...
        vec![
            ...
            Rule::token_to(
                r"(?im)/\*",
                KEYWORD_PSEUDO,
                NewState::Push(vec![r"jes2_statement"]),
            ),
            Rule::token(r"(?im).*\n", OTHER),
        ],
    );
    m.insert(
        ...
        vec![
            ...
            Rule::bygroups_to(
                ...
                NewState::Push(vec![r"option"]),
            ),
            Rule::token_to(
                r"(?im)[a-z]\w*",
                NAME_VARIABLE,
                NewState::Push(vec![r"statement_command"]),
            ),
            Rule::token_to(
                r"(?im)\s+",
                WHITESPACE,
    ...
    m.insert(
        ...
        vec![
            ...
            Rule::token_to(
                r"(?im)[ \t]+",
                WHITESPACE,
                NewState::Push(vec![r"option_comment"]),
            ),
            Rule::token(r"(?im)\.", PUNCTUATION),
        ],
    );
    ...
    m.insert(
        r"option_comment",
        vec![Rule::token(r"(?im).+", COMMENT_SINGLE)],
    );
    Table(m)
}
