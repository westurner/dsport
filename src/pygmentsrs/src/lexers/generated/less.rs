//! AUTO-GENERATED from `pygments.pygments.lexers.css:LessCssLexer`.
//!
//! Do not edit by hand. Regenerate with:
//!   python tools/gen_lexer.py pygments.lexers.css:LessCssLexer:less
