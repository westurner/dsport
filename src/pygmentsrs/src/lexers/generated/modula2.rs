...
fn build_table() -> Table {
    ...
    m.insert(r"unigraph_operators", vec![
        Rule::token(r"(?ms)[+-]", OPERATOR),
        Rule::token(r"(?ms)[*/]", OPERATOR),
        Rule::token(r"(?ms)\\", OPERATOR),
        Rule::token(r"(?ms)[=#<>]", OPERATOR),
    ...
    m.insert(r"digraph_punctuation", vec![
    ...
    m.insert(r"unigraph_punctuation", vec![
        Rule::token(r"(?ms)[()\[\]{},.:;|]", PUNCTUATION),
        Rule::token(r"(?ms)!", PUNCTUATION),
        Rule::token(r"(?ms)\?", PUNCTUATION),
    ]);
