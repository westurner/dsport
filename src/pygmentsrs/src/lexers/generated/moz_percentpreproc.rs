//! AUTO-GENERATED from `pygments.pygments.lexers.markup:MozPreprocPercentLexer`.
//!
//! Do not edit by hand. Regenerate with:
//!   python tools/gen_lexer.py pygments.lexers.markup:MozPreprocPercentLexer:moz_percentpreproc
...
pub struct MozPercentpreprocLexer;
...
impl Lexer for MozPercentpreprocLexer {
