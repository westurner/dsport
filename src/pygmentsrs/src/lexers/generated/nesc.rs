//! AUTO-GENERATED from `pygments.pygments.lexers.c_like:NesCLexer`.
//!
//! Do not edit by hand. Regenerate with:
//!   python tools/gen_lexer.py pygments.lexers.c_like:NesCLexer:nesc
...
fn build_table() -> Table {
    ...
    m.insert(r"statements", vec![
        Rule::token(r"(?m)(a(?:bstract|s(?:(?:ync)?)|tomic)|c(?:all|o(?:m(?:mand|ponent(?:(?:s)?))|nfiguration))|e(?:vent|xtends)|generic|i(?:mplementation|n(?:cludes|terface))|module|n(?:ew|orace)|p(?:ost|rovides)|signal|task|uses)\b", KEYWORD),
        Rule::token(r"(?m)(nx_(?:int(?:(?:16|32|64|8)_t)|struct|u(?:int(?:(?:16|32|64|8)_t)|nion)))\b", KEYWORD_TYPE),
