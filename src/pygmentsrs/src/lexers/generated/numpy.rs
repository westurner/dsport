...
//! AUTO-GENERATED from `pygments.pygments.lexers.python:NumPyLexer`.
//!
//! Do not edit by hand. Regenerate with:
//!   python tools/gen_lexer.py pygments.lexers.python:NumPyLexer:numpy
...
fn build_table() -> Table {
    ...
    m.insert(r"root", vec![
        ...
        Rule::bygroups_to(r"(?m)(^[ \t]*)(match|case)\b(?![ \t]*(?:[:,;=^&|@~)\]}]|(?:and|as|assert|async|await|break|class|continue|def|del|elif|else|except|finally|for|from|global|if|import|in|is|lambda|nonlocal|not|or|pass|raise|return|try|while|with|yield)\b))", vec![Some(TEXT), Some(KEYWORD)], NewState::Push(vec![r"soft-keywords-inner"])),
        ...
        Rule::bygroups_to(r#"(?m)(?i)(r[ft]|[ft]r)(""")"#, vec![Some(STRING_AFFIX), Some(STRING_DOUBLE)], NewState::Push(vec![r"_tmp_0"])),
        Rule::bygroups_to(r"(?m)(?i)(r[ft]|[ft]r)(''')", vec![Some(STRING_AFFIX), Some(STRING_SINGLE)], NewState::Push(vec![r"_tmp_1"])),
        Rule::bygroups_to(r#"(?m)(?i)(r[ft]|[ft]r)(")"#, vec![Some(STRING_AFFIX), Some(STRING_DOUBLE)], NewState::Push(vec![r"_tmp_2"])),
        Rule::bygroups_to(r"(?m)(?i)(r[ft]|[ft]r)(')", vec![Some(STRING_AFFIX), Some(STRING_SINGLE)], NewState::Push(vec![r"_tmp_3"])),
        Rule::bygroups_to(r#"(?m)([fFtT])(""")"#, vec![Some(STRING_AFFIX), Some(STRING_DOUBLE)], NewState::Push(vec![r"_tmp_4"])),
        Rule::bygroups_to(r"(?m)([fFtT])(''')", vec![Some(STRING_AFFIX), Some(STRING_SINGLE)], NewState::Push(vec![r"_tmp_5"])),
        Rule::bygroups_to(r#"(?m)([fFtT])(")"#, vec![Some(STRING_AFFIX), Some(STRING_DOUBLE)], NewState::Push(vec![r"_tmp_6"])),
        Rule::bygroups_to(r"(?m)([fFtT])(')", vec![Some(STRING_AFFIX), Some(STRING_SINGLE)], NewState::Push(vec![r"_tmp_7"])),
        ...
        Rule::token(r"(?m)(a(?:sync\ for|wait)|else|for|if|lambda|yield(?:(?:\ from)?))\b", KEYWORD),
        Rule::token(r"(?m)((?:Fals|Non|Tru)e)\b", KEYWORD_CONSTANT),
    ...
    m.insert(
        ...
        vec![
            ...
            Rule::token_to(
                r"(?m)\{",
                STRING_INTERPOL,
                NewState::Push(vec![r"expr-inside-fstring"]),
            ),
            Rule::token(r#"(?m)[^\\\'"{}\n]+"#, STRING_DOUBLE),
    ...
    m.insert(
        ...
        vec![
            ...
            Rule::token(r"(?m)\}\}", STRING_ESCAPE),
            Rule::token(
                r"(?m)\\(N\{.*?\}|u[a-fA-F0-9]{4}|U[a-fA-F0-9]{8})",
                STRING_ESCAPE,
            ),
            Rule::token(
    ...
    m.insert(
        ...
        vec![
            Rule::token(
                r"(?m)(a(?:sync\ for|wait)|else|for|if|lambda|yield(?:(?:\ from)?))\b",
                KEYWORD,
            ),
            Rule::token(r"(?m)((?:Fals|Non|Tru)e)\b", KEYWORD_CONSTANT),
        ],
