//! AUTO-GENERATED from `pygments.pygments.lexers.asm:NasmObjdumpLexer`.
//!
//! Do not edit by hand. Regenerate with:
//!   python tools/gen_lexer.py pygments.lexers.asm:NasmObjdumpLexer:objdump_nasm
...
fn build_table() -> Table {
    ...
    m.insert(r"root", vec![
        ...
        Rule::bygroups_g(r"(?m)( *)([0-9A-Za-z]+:)(\t)((?:[0-9A-Za-z][0-9A-Za-z] )+)( *	)([a-zA-Z].*?)$", vec![Some(GroupAction::Token(WHITESPACE)), Some(GroupAction::Token(NAME_LABEL)), Some(GroupAction::Token(WHITESPACE)), Some(GroupAction::Token(NUMBER_HEX)), Some(GroupAction::Token(WHITESPACE)), Some(GroupAction::UsingLexer { alias: "nasm", state: None })]),
        Rule::bygroups_g(r"(?m)( *)([0-9A-Za-z]+:)( *\t)([a-zA-Z].*?)$", vec![Some(GroupAction::Token(WHITESPACE)), Some(GroupAction::Token(NAME_LABEL)), Some(GroupAction::Token(WHITESPACE)), Some(GroupAction::UsingLexer { alias: "nasm", state: None })]),
...
impl Lexer for ObjdumpNasmLexer {
