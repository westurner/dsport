//! AUTO-GENERATED from `pygments.pygments.lexers.objective:ObjectiveCppLexer`.
//!
//! Do not edit by hand. Regenerate with:
//!   python tools/gen_lexer.py pygments.lexers.objective:ObjectiveCppLexer:objective_cpp
