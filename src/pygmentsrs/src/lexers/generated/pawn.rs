//! AUTO-GENERATED from `pygments.pygments.lexers.pawn:PawnLexer`.
//!
//! Do not edit by hand. Regenerate with:
//!   python tools/gen_lexer.py pygments.lexers.pawn:PawnLexer:pawn
...
fn build_table() -> Table {
    ...
    m.insert(r"root", vec![
        ...
        Rule::token(r"(?m)[()\[\],.;]", PUNCTUATION),
        Rule::token(r"(?m)(switch|case|default|const|new|static|char|continue|break|if|else|for|while|do|operator|enum|public|return|sizeof|tagof|state|goto)\b", KEYWORD),
