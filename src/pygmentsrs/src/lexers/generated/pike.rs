...
//! AUTO-GENERATED from `pygments.pygments.lexers.c_like:PikeLexer`.
//!
//! Do not edit by hand. Regenerate with:
//!   python tools/gen_lexer.py pygments.lexers.c_like:PikeLexer:pike
...
fn build_table() -> Table {
    ...
    m.insert(r"statements", vec![
        Rule::token(r"(?m)(_(?:Pragma|_(?:(?:AUTO_BIGNUM|BUILD|D(?:ATE|IR)|FILE|LINE|M(?:(?:AJ|IN)OR)|NT|PIKE|REAL_(?:BUILD|M(?:(?:AJ|IN)OR)|VERSION)|TIME|VERSION|amigaos)__))|a(?:bstract|s)|break|c(?:a(?:se|tch)|lass|on(?:stant|tinue))|d(?:efined|o)|e(?:lse|xte(?:nds|rn))|f(?:alse|inal|or|rom)|gauge|i(?:mp(?:(?:lemen|or)t)|n(?:(?:lin|terfac)e)|[fn])|n(?:ew|ull)|p(?:r(?:ivate|ot(?:ected|o))|ublic)|return|s(?:scanf|tatic(?:(?:_assert)?)|uper|witch)|t(?:h(?:is|row(?:(?:s)?))|rue)|use|version|while)\b", KEYWORD),
        Rule::token(r"(?m)(bool|int|long|float|short|double|char|string|object|void|mapping|array|multiset|program|function|lambda|mixed|[a-z_][a-z0-9_]*_t)\b", KEYWORD_TYPE),
