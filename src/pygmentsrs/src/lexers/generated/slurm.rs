//! AUTO-GENERATED from `pygments.pygments.lexers.shell:SlurmBashLexer`.
//!
//! Do not edit by hand. Regenerate with:
//!   python tools/gen_lexer.py pygments.lexers.shell:SlurmBashLexer:slurm
