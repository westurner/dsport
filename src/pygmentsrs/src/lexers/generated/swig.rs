//! AUTO-GENERATED from `pygments.pygments.lexers.c_like:SwigLexer`.
//!
//! Do not edit by hand. Regenerate with:
//!   python tools/gen_lexer.py pygments.lexers.c_like:SwigLexer:swig
...
fn build_table() -> Table {
    ...
    m.insert(r"statements", vec![
        Rule::token(r"(?m)(%[a-z_][a-z0-9_]*)", NAME_FUNCTION),
        Rule::token(r"(?m)\$\**\&?\w+", NAME),
