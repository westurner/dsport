//! AUTO-GENERATED from `pygments.pygments.lexers.jvm:XtendLexer`.
//!
//! Do not edit by hand. Regenerate with:
//!   python tools/gen_lexer.py pygments.lexers.jvm:XtendLexer:xtend
...
fn build_table() -> Table {
    ...
    m.insert(r"root", vec![
        ...
        Rule::token(r"(?ms)(assert|break|case|catch|continue|default|do|else|finally|for|if|goto|instanceof|new|return|switch|this|throw|try|while|IF|ELSE|ELSEIF|ENDIF|FOR|ENDFOR|SEPARATOR|BEFORE|AFTER)\b", KEYWORD),
        Rule::token(r"(?ms)(def|abstract|const|enum|extends|final|implements|native|private|protected|public|static|strictfp|super|synchronized|throws|transient|volatile|val|var)\b", KEYWORD_DECLARATION),
        ...
        Rule::token_to(r"(?ms)(''')", STRING, NewState::Push(vec![r"template"])),
        Rule::token_to(r"(?ms)(\u00BB)", STRING, NewState::Push(vec![r"template"])),
