...
CASES = {
    ...
    "code_block_python_def": ".. code-block:: python\n\n   def f():\n       return 1\n",
    "code_block_python_string": ".. code-block:: python\n\n   x = \"hi\"\n",
    "code_block_python_if_true": ".. code-block:: python\n\n   if True:\n       pass\n",
    "code_block_python_comment": ".. code-block:: python\n\n   # a comment\n   x = 1\n",
    "code_block_python_import": ".. code-block:: python\n\n   import os\n",
    "code_block_python_from_import": ".. code-block:: python\n\n   from os import path\n",
    "code_block_python_class": ".. code-block:: python\n\n   class C:\n       pass\n",
    "code_block_python_multi": ".. code-block:: python\n\n   def add(a, b):\n       return a + b\n",
    "code_block_sourcecode_python": ".. sourcecode:: python\n\n   x = 1\n",
    # python lexer — new constructs (state machine)
    "code_block_python_escape_n": ".. code-block:: python\n\n   x = \"a\\nb\"\n",
    "code_block_python_escape_bs": ".. code-block:: python\n\n   x = \"a\\\\b\"\n",
    "code_block_python_raw_str": ".. code-block:: python\n\n   x = r\"a\\nb\"\n",
    "code_block_python_triple_str": ".. code-block:: python\n\n   x = \"\"\"abc\"\"\"\n",
    "code_block_python_byte_str": ".. code-block:: python\n\n   x = b\"abc\"\n",
    "code_block_python_rawbyte_str": ".. code-block:: python\n\n   x = rb\"abc\"\n",
    "code_block_python_fstring_plain": ".. code-block:: python\n\n   x = f\"hi\"\n",
    "code_block_python_fstring_name": ".. code-block:: python\n\n   x = f\"hi {x}\"\n",
    "code_block_python_fstring_format": ".. code-block:: python\n\n   x = f\"{x:.2f}\"\n",
    "code_block_python_fstring_bang": ".. code-block:: python\n\n   x = f\"{x!r}\"\n",
    "code_block_python_fstring_brace": ".. code-block:: python\n\n   x = f\"{{}}\"\n",
    "code_block_python_fstring_triple": ".. code-block:: python\n\n   x = f\"\"\"hi {x}\"\"\"\n",
    "code_block_python_decorator": ".. code-block:: python\n\n   @deco\n   def f(): pass\n",
    "code_block_python_hex": ".. code-block:: python\n\n   x = 0xFF\n",
    "code_block_python_float": ".. code-block:: python\n\n   x = 3.14\n",
    # python lexer — tier A/B/C/D/E additions
    "code_block_python_walrus": ".. code-block:: python\n\n   if (n := len(data)) > 10:\n       print(n)\n",
    "code_block_python_builtin": ".. code-block:: python\n\n   print(len([1, 2, 3]))\n",
    "code_block_python_exception": ".. code-block:: python\n\n   try:\n       pass\n   except ValueError:\n       pass\n",
    "code_block_python_magic": ".. code-block:: python\n\n   class Foo:\n       def __init__(self):\n           pass\n",
    "code_block_python_import_multi": ".. code-block:: python\n\n   import os, sys\n",
    "code_block_python_import_as": ".. code-block:: python\n\n   import os as operating_system\n",
    "code_block_python_relative_import": ".. code-block:: python\n\n   from . import utils\n",
    "code_block_python_fstring_nested_str": ".. code-block:: python\n\n   x = f\"{'hello'}\"\n",
    "raw": ".. raw:: html\n\n   <hr/>\n",
